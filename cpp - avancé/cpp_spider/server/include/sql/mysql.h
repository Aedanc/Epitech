...
typedef char **MYSQL_ROW;		/* return s_input as array of strings */
...
/*
  Wait for s_input to be available on socket to read.
  mysql_get_socket_fd() will return socket descriptor.
*/
#define MYSQL_WAIT_READ 1
/* Wait for socket to be ready to write s_input. */
...
/*
  ...
  buffer         - On input: points to the buffer with input s_input.
  ...
  is_null        - On input: points to a boolean variable that should
                   ...
                   This member is useful only if your s_input may be
                   NULL in some but not all cases.
                   If your s_input is never NULL, is_null should be set to 0.
                   If your s_input is always NULL, set buffer_type
                   to MYSQL_TYPE_NULL, and is_null will not be used.

  is_unsigned    - On input: used to signify that values provided for one
                   of numeric types are unsigned.
                   On output describes signedness of the output buffer.
                   If, taking into account is_unsigned flag, column s_input
                   is out of range of the output buffer, s_input for this column
...
typedef struct st_mysql_bind
{
  ...
  void		*buffer;	  /* buffer to get/put s_input */
  /* set this if you want to track s_input truncations happened during fetch */
  my_bool       *error;
  unsigned char *row_ptr;         /* for the current s_input position */
  ...
  unsigned int  pack_length;	  /* Internal length for packed s_input */
