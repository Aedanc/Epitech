//
// Chipset4081.cpp for nanotekspice in /home/quersi_l/rendu/cpp_nanotekspice/sources
// 
// Made by Laurent QUERSIN
// Login   <quersi_l@epitech.net>
// 
// Started on  Thu Feb 23 11:29:31 2017 Laurent QUERSIN
// Last update Sat Mar  4 00:47:18 2017 Laurent QUERSIN
//
...
nts::Tristate	Chipset4081::Compute(size_t pin)
{
  nts::Tristate i1;
  nts::Tristate i2;
...
void		Chipset4081::SetLink(size_t from, nts::IComponent &cmp, size_t to)
{
  Link        *p;
  std::ostringstream oss;
  oss << "SetLink on 4081: pin " << from;
...
void		Chipset4081::Dump() const
{
  std::cout << _name << std::endl;
  std::cout << "Chipset4081:" <<std::endl;
...
void		Chipset4081::SetState(nts::Tristate state)
{
  static_cast<void>(state);
}

AComponent	*Create4081(const std::string &name)
{
  return (new Chipset4081(name));
}
